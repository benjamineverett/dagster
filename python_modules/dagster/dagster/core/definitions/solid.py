...
from dagster.utils import frozendict, frozenlist, frozentags
...
class ISolidDefinition(six.with_metaclass(ABCMeta)):
    def __init__(
        ...
        self._tags = frozentags(check.opt_dict_param(tags, 'tags', key_type=str, value_type=str))
    ...
    def tag(self, tags):
        ...
        return CallableSolidNode(self, tags=frozentags(check.dict_param(tags, 'tags', str, str)))
